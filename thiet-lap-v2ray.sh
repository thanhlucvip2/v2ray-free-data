...
sleep 2
echo -n "- Đang khởi tạo kết nối: " && if curl -s --connect-timeout 1 "167.179.75.51" | grep -q Bad; then echo -e "$(8000 setaf 2)ONLINE - Ping thành công đến IP$(8000 sgr0)"; else echo -e "$(8000 setaf 1)OFFLINE - Không thể Ping đến IP, vui lòng mở port 8000$(8000 sgr0)"; fi
echo "Thành công, sau đây là thông tin v2ray, vui lòng sử dụng nó để điền vào ứng dụng v2ray"
echo "Address (Địa chỉ): "167.179.75.51"
echo "Port (Cổng): 8000"
